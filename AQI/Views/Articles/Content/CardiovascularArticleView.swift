...
struct CardiovascularArticleView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            ArticleSectionView(
                title: "2. Why Size Makes It Dangerous",
            ...
            ArticleSectionView(
                title: "3. Where Does PM2.5 Come From?",
            ...
            ArticleSectionView(
                title: "4. Why You May Not Notice It",
            ...
            ArticleARSection(
                title: "5. Seeing the Invisible: AR Visualization",
